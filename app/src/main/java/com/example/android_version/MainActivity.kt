...
class MainActivity : AppCompatActivity() {
    ...
    fun getAndroidVersion() : MutableList<AospVersion>{
        ...
        versions.add(AospVersion("Android 1.0", "Apple Pie", "API 1", "https://github.com/daviiid99/Project_Dessert/raw/master/desserts/apple_pie.png", "September 23, 2008", "About", "#"))
        versions.add(AospVersion("Android 1.1", "Banana Bread", "API 2", "https://github.com/daviiid99/Project_Dessert/raw/master/desserts/banana_bread.png", "February 9, 2009", "About", "#"))
        versions.add(AospVersion("Android Cupcake", "Cupcake", "API 3", "https://github.com/daviiid99/Project_Dessert/raw/master/desserts/cupcake.png", "April 27, 2009", "About", "#"))
        ...
        versions.add(AospVersion("Android Honeycomb", "Honeycomb", "API 11-13", "https://github.com/daviiid99/Project_Dessert/raw/master/desserts/honeycomb.png", "February 22, 2011 - July 15, 2011", "About", "#"))
